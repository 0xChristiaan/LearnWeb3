...
export default function Home() {
    ...
    */
    const renderButton = () => {
        ...
        if (liquidityTab) {
            return ( <
                ...
                You have:
                <
                br / > { /* Convert the BigNumber to string using the formatEther function from ethers.js */ } { utils.formatEther(cdBalance) }
                Crypto Dev Tokens <
                br / > { utils.formatEther(ethBalance) }
                Ether <
                br / > { utils.formatEther(lpBalance) }
                ...
                div > {
                    ...
                    utils.parseEther(reservedCD.toString()).eq(zero) ? ( <
                        ...
                        onChange = {
                            (e) => setAddEther(e.target.value || "0")
                        }
                        ...
                        className = { styles.input }
                        /> <
                        div className = { styles.inputDiv } > { /* Convert the BigNumber to string using the formatEther function from ethers.js */ } { `You will need ${utils.formatEther(addCDTokens)} Crypto Dev
                  Tokens` } <
                        /div> <
                        button className = { styles.button1 }
                        onClick = { _addLiquidity } >
                ...
                className = { styles.input }
                /> <
                div className = { styles.inputDiv } > { /* Convert the BigNumber to string using the formatEther function from ethers.js */ } { `You will get ${utils.formatEther(removeCD)} Crypto
            ...
            return ( <
                ...
                br / >
                <
                div className = { styles.inputDiv } > { /* Convert the BigNumber to string using the formatEther function from ethers.js */ } {
                    ethSelected
                        ?
    ...
    return ( <
            ...
            div className = { styles.description } >
            Exchange Ethereum & #60;&# 62; Crypto Dev Tokens <
            /div> <
            div >
            <
