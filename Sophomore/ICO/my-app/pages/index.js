    ...
    const renderButton = () => {
        ...
        if (tokensToBeClaimed > 0) {
            return ( <
                div >
                <
                div className = { styles.description } > { tokensToBeClaimed * 10 }
        ...
        return ( <
            ...
            onChange = {
                (e) => setTokenAmount(BigNumber.from(e.target.value)) }
    ...
    return ( <
            ...
            /div> {
                walletConnected ? ( <
                    div >
                    <
                    div className = { styles.description } > { /* Format Ether helps us in converting a BigNumber to string */ }
